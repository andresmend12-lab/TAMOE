...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const actionTemplates = {
        notify: `<div class="p-4 rounded-lg bg-gray-50 dark:bg-surface-dark border border-gray-200 dark:border-border-dark flex flex-col gap-3"><label class="text-xs font-bold uppercase text-text-muted mt-2">Mensaje</label><textarea class="w-full bg-white dark:bg-surface-darker border border-gray-200 dark:border-border-dark rounded-lg p-2 text-gray-900 dark:text-white" placeholder="Escribe tu mensaje..."></textarea></div>`,
        move: `<div class="p-4 rounded-lg bg-gray-50 dark:bg-surface-dark border border-gray-200 dark:border-border-dark flex flex-col gap-3"><label class="text-xs font-bold uppercase text-text-muted">Mover a Proyecto</label><select class="w-full h-12 rounded-lg bg-white dark:bg-surface-darker border border-gray-200 dark:border-border-dark text-gray-900 dark:text-white focus:border-primary focus:ring-1 focus:ring-primary pl-4 pr-10 appearance-none cursor-pointer"><option>Proyecto Phoenix</option><option>Proyecto Titán</option></select></div>`,
        createChild: `<div class="p-4 rounded-lg bg-gray-50 dark:bg-surface-dark border border-gray-200 dark:border-border-dark flex flex-col gap-3"><label class="text-xs font-bold uppercase text-text-muted child-activity-name-label">Nombre del Nuevo</label><input class="w-full bg-white dark:bg-surface-darker border border-gray-200 dark:border-border-dark rounded-lg p-2 text-gray-900 dark:text-white child-activity-name-input" type="text"/></div>`
    };
